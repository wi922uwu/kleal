...
_KW = {
    ...
    "tech": [("ai",), ("ml",),
             ...
             ("crypto", "cryptocurrency", "bitcoin", "blockchain", "web3", "defi",
              "cripto", "criptomoneda", "крипта", "криптовалюта", "биткоин", "блокчейн"),
             ("data", "datos", "данные"),
    ...
    "career": [("networking", "нетворкинг"),
               ...
               ("investing", "investment", "trading", "forex", "nasdaq", "stocks", "equities",
                "inversión", "inversion", "finanzas", "financieros", "acciones", "bolsa",
                "инвестиции", "трейдинг", "форекс", "фондовый", "биржа", "акции")],
