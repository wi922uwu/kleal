...
console.log('\nвкладка «Моя активность» связана из конца в конец');
{
  ...
  check('строки планов не пересобраны заново',
    /from '\.\.\/src\/messages'/.test(scr) && /planRows\(/.test(scr) && /gplanRows\(/.test(scr),
    'у «Сообщений» и «Активности» данные одни — сборщик обязан быть один');
