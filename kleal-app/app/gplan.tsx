...
export default function GroupPlan() {
  ...
  /**
   * Кто внёс нынешнее предложение. Сервер такого поля не отдаёт, но оно выводится: встречное
   * предложение обнуляет все подтверждения и ставит одно — своё. Значит на раунде выше первого
   * единственный подтвердивший и есть предложивший, и на борде у него подпись «Suggested this ·
   * confirmed» (GR.28). Считается ОДИН раз и здесь, чтобы заголовок и строка в составе не назвали
   * разных людей.
   */
