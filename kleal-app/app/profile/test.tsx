/**
 * Тест от Kleal — восемь вопросов и РОВНО один вызов модели в конце.
 *
 * По обращению к модели на каждый вопрос — это восемь шансов повиснуть на цепочке без отмены, ради
 * вопросов, которые в тесте и так заданы заранее. Поэтому вся лестница на клиенте, а
